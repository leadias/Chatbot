class Constants(object):
    WELLCOME_MSJ = 'Hola {}!! Bienvenid@, soy el bot encargado de las recomendaciones. Para darte sugerencias respecto a un producto o categoria por favor escribe "*" seguido del nombre del producto o la categoria de la cual deseas sugerencias'
    INITIAL_MSJS = ['hola', 'ola', 'hi', 'como estas', 'buenos dias', 'buenas tardes', 'buenas noches']
